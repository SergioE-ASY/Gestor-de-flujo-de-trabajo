...
export interface User { id: string; name: string; username?: string; password?: string; initials: string; role: UserRole; avatar_color: string; workload: Workload; email: string; status: string; }
